...
The accent colours of the petrel theme were derived from the seagull colours by reducing saturation of all hues by ½, then reducing value to a contrast ratio of 4½ (with the petrel background). All petrel accent colours are therefore W3C AA compliant.
